...
def extract_dft_functionals_from_file(filepath):
    ...
    # Common DFT functionals and quantum chemistry methods
    dft_patterns = {
        # DFT Functionals
        'B3LYP': r'\bB3LYP\b',
        'PBE': r'\bPBE\b(?!0)',
        ...
        'M06-L': r'\bM06-?L\b',
        'M06-HF': r'\bM06-?HF\b',
        'wB97X-D': r'\bwB97X-?D\b',
        'wB97X': r'\bwB97X\b',
        'CAM-B3LYP': r'\bCAM-?B3LYP\b',
        'LC-wPBE': r'\bLC-?wPBE\b',
        'BLYP': r'\bBLYP\b',
        'BP86': r'\bBP86\b',
        'TPSSh': r'\bTPSSh\b',
        'TPSS': r'\bTPSS\b',
        ...
        'MN15': r'\bMN15\b',
        'MN15-L': r'\bMN15-?L\b',
        'SCAN': r'(?:^|\s|#)SCAN(?:\s|/|$)',  # SCAN functional in proper context
        'revPBE': r'\brevPBE\b',
        'OLYP': r'\bOLYP\b',
        'X3LYP': r'\bX3LYP\b',
        'B3P86': r'\bB3P86\b',
        ...
        'M11-L': r'\bM11-?L\b',
        'MN12-L': r'\bMN12-?L\b',
        'MN12-SX': r'\bMN12-?SX\b',
        'N12': r'\bN12\b',
        'N12-SX': r'\bN12-?SX\b',
        'SOGGA11': r'\bSOGGA11\b',
        'SOGGA11-X': r'\bSOGGA11-?X\b',
        'wb97': r'\bwb97\b',
        'wb97x': r'\bwb97x\b',
        'wb97xd': r'\bwb97xd\b',
        
        # Wave function methods - more specific patterns
        'HF': r'(?:^|\s|#)HF(?:\s|/|$)',  # HF in proper context, not part of other words
        'RHF': r'\bRHF\b',
        'UHF': r'\bUHF\b',
        'ROHF': r'\bROHF\b',
        'MP2': r'\bMP2\b',
        ...
        # Special functionals and methods
    ...
    with open(output_file, 'w') as f:
        ...
        for method in sorted(all_methods.keys()):
            ...
            for filepath in sorted(files.keys()):
                ...
                for occurrence in files[filepath]:
